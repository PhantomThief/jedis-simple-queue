 ...
 * @author w.vela
 */
public abstract class AbsListJedisQueuePoper<K, E, R> implements Supplier<E> {
     ...
     * @param decoder
     */
    protected AbsListJedisQueuePoper(K queueKey, Supplier<List<JedisPool>> jedisFactory,
